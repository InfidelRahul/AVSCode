...
class VsCodeServerLifecycleTest {
    ...
    fun testBuildServerCommandCustomHostAndPort() {
        ...
        assertEquals(
            "/usr/local/bin/code serve-web --host 127.0.0.1 --port 10050 --without-connection-token --accept-server-license-terms --cli-data-dir /home/user/.vscode-cli --user-data-dir /home/user/.vscode-cli/data",
            cmd
        )
    }
